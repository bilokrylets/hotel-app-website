...
import { Cabin as CabinType } from "../_types/cabin";

type Props = { cabin: CabinType };
function Cabin({ cabin }: Props) {
  ...
  return (
    <div className="mb-24 grid grid-cols-[3fr_4fr] gap-20 border border-primary-800 px-10 py-3">
      ...
      <div>
        <h3 className="mx mb-5 w-[150%] translate-x-[-254px] bg-primary-950 p-6 pb-1 text-7xl font-black text-accent-100">
          Cabin {name}
        </h3>
